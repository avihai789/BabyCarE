package com.example.babycare.restarter;
...
import com.example.babycare.Globals;
import com.example.babycare.ProcessMainClass;
...
public class RestartServiceBroadcastReceiver extends BroadcastReceiver {
    ...
    public static void scheduleJob(Context context) {
        ...
        @SuppressLint("JobSchedulerService") ComponentName componentName = new ComponentName(context,
                JobService.class);
